...
import { EndOfSubSlotBundle } from '../chia/EndOfSubSlotBundle';
import { FullBlock } from '../chia/FullBlock';
import { MempoolItem } from '../chia/MempoolItem';
...
export class FullNode extends Client {
    ...
    public async getBlockchainState(): Promise<Response<GetBlockchainState>> {
        return await this.request<GetBlockchainState>(
    ...
    public async getAllMempoolTxIds(): Promise<Response<GetAllMempoolTxIds>> {
        return await this.request<GetAllMempoolTxIds>(
